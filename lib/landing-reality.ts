...
markup = replace(markup, "No credit card required. Add your game title and try the interactive monitoring demo.", "Public beta is opening shortly. Signup is temporarily locked for the final customer-contact setup; paid checkout will open after Paddle LIVE activation.");
...
markup = replace(markup, "Email or Discord takes you straight to the video or stream before the momentum fades.", "Eligible paid plans can receive one opt-in daily email digest. Studio and Publisher can also send matching signals to Discord.");
...
markup = replace(markup, "A simple subscription model based on the number of tracked games and how quickly you want alerts to arrive.", "Public beta pricing. Free signup will open after the final customer-contact setup; new paid subscriptions will open when Paddle LIVE activation is complete. Paddle will act as Merchant of Record for paid customer transactions.");
...
markup = replace(markup, '<div class="notice">Interactive frontend demo. A production version still needs APIs, a database, auth, and payments.</div>', '<div class="notice">After signup opens, YouTube and Twitch monitoring starts automatically. Notification settings are available in your account; Kick is coming soon.</div>');
...
markup = replace(markup, '<div class="notice">This demo does not process any payments.</div>', '<div class="notice">New account signup is temporarily locked for final launch contact setup. Paid checkout remains unavailable until Paddle LIVE activation is completed.</div>');
