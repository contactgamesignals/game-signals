...
markup = replace(markup, '<div class="notice">Interactive frontend demo. A production version still needs APIs, a database, auth, and payments.</div>', '<div class="notice">Active YouTube and Twitch monitoring starts after you choose a paid plan. Notification settings are available in your account; Kick is coming soon.</div>');
