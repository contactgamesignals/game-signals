...
assert.match(deletion, /billing_subscription_id/);
assert.match(deletion, /hasProviderSubscription/);
assert.match(deletion, /billing_provider === "paddle"/);
assert.match(deletion, /subscription\?\.status !== "canceled"/);
assert.match(deletion, /Your paid subscription is scheduled to end/);
