...
export const metadata: Metadata = {
  ...
  description: "Privacy information for the GameSignal closed beta operated by Lumino Games sp. z o.o.",
};
  ...
  return (
    <main className="auth-page" style={{ alignItems: "flex-start", paddingTop: 48, paddingBottom: 64 }}>
      <article className="auth-card" style={{ width: "min(920px, 100%)", maxWidth: 920 }}>
        ...
        <p>
          This policy explains how personal data is handled in the GameSignal closed beta. GameSignal is a product operated by {COMPANY.legalName}.
        </p>
        ...
        <ul>
          ...
          <li>subscription and billing identifiers generated by Stripe. The closed beta currently uses Stripe sandbox and does not accept real payments;</li>
          <li>notification settings, including a Discord webhook if you choose to connect Discord;</li>
          <li>technical and security information needed to operate and protect the service, such as timestamps, request metadata and service logs;</li>
        ...
        <ul>
          <li><strong>Providing the service and account:</strong> to create your account, workspace, monitors, dashboard and settings. The legal basis is performance of a contract or steps taken at your request before entering a contract.</li>
          ...
          <li><strong>Legal and accounting duties:</strong> where applicable, to comply with legal obligations. Real paid billing is not yet enabled in the closed beta.</li>
        ...
        <p>
          Some technology providers may process data outside Poland or the European Economic Area. Where required, transfers are handled using the safeguards made available under applicable data-protection law, such as adequacy decisions or standard contractual clauses used by the relevant provider.
        </p>

        <h2>6. Retention</h2>
        <p>
          Account and workspace data is generally kept while the account or workspace is active. Monitoring history is retained as needed to provide the signal-history features of the service. When an account is eligible for permanent deletion, the deletion flow removes the account and owned workspace data, subject to data we must retain because of legal obligations, disputes, security requirements or backup lifecycles.
        </p>
        <p>
          Public creator/content metadata is retained only as reasonably needed to provide and maintain GameSignal signal history. If you are a creator whose public data appears in GameSignal and you want to raise a privacy objection, contact us at the address above.
        </p>
