  ...
  return (
    <main className="auth-page" style={{ alignItems: "flex-start", paddingTop: 48, paddingBottom: 64 }}>
      <article className="auth-card" style={{ width: "min(920px, 100%)", maxWidth: 920 }}>
        ...
        <p>
          Checkout-consent evidence and transaction-related records may be retained longer than the active account where reasonably necessary to meet legal, tax, accounting or claims-defense obligations. Public creator/content metadata is retained only as reasonably needed to provide and maintain GameSignal signal history.
        </p>
